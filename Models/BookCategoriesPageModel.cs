...
namespace Porumb_Denisa_Lab2.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Porumb_Denisa_Lab2Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Porumb_Denisa_Lab2Context context, string[] selectedCategories, Book bookToUpdate)
        {
